...
public class HandleLogin {
	...
	public static boolean checkUnAndPw(String email, String password) {
		...
		emailAndPw = jp.getJsonArray(MainActivity.SERVER_URL + "/email.py?q=login&email=" + email + "&pass=" + password);
	...
	public static User getCurrentEmailUserLoggedIn(String email){
		...
		JsonParser jp = new JsonParser();
		JSONArray emailUser;
		emailUser = jp.getJsonArray(MainActivity.SERVER_URL + "/usr.py?q=emailUser&email=" + email);
